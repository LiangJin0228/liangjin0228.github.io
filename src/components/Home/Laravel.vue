<template>
  <div class="fade-in mb-14" :class="{ 'mt-16 pt-16': smAndUp }">
    <v-card hover href="https://laravel.com/" rounded="xl" target="_blank">
      <div class="pt-10 fade-in d-flex justify-center">
        <svg viewBox="0 -.11376601 49.74245785 51.31690859" width="120px" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <v-card-text class="text-subtitle-1 font-weight-black fade-in laravel-gradient-text gradient-text">
