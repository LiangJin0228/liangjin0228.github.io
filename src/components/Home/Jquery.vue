    ...
    <div class="fade-in mb-14">
        <v-card href="https://jquery.com/" target="_blank" rounded="xl" hover>
            <div class="pt-4 fade-in d-flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="120px" viewBox="0 0 32 32" fill="#0868ac">
                    <path
            ...
            <v-card-text class="text-subtitle-1 font-weight-black fade-in jquery-gradient-text gradient-text">
