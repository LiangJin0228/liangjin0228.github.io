    ...
    <div class="fade-in mb-14">
        <v-card href="https://vuejs.org/" target="_blank" rounded="xl" hover>
            <div class="fade-in d-flex justify-center">
                <svg width="120px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <v-card-text class="text-subtitle-1 font-weight-black fade-in vue-gradient-text gradient-text">
