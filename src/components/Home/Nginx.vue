<template>
  <div class="fade-in">
    <v-card hover href="https://nginx.org/" rounded="xl" target="_blank">
      ...
      <v-card-text class="text-subtitle-1 font-weight-black fade-in nginx-gradient-text gradient-text">
