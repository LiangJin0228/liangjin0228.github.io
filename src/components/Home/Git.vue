<template>
  <div class="fade-in mb-14">
    <v-card hover href="https://git-scm.com/" rounded="xl" target="_blank">
      <div class="pt-7 fade-in d-flex justify-center">
        <svg viewBox="0 0 219 92" width="120px" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <clipPath id="a">
      ...
      <v-card-text class="text-subtitle-1 font-weight-black fade-in git-gradient-text gradient-text">
