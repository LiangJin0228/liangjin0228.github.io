<template>
  <div class="fade-in mb-14">
    <v-card hover href="https://www.php.net/" rounded="xl" target="_blank">
        ...
        >
          <defs id="defs3434">
            ...
            <clipPath id="clipPath3468" clipPathUnits="userSpaceOnUse">
              <path id="path3470" d="M 0,324 576,324 576,0 0,0 0,324 Z" />
            </clipPath>
            <clipPath id="clipPath3480" clipPathUnits="userSpaceOnUse">
              <path id="path3482" d="M 0,324 576,324 576,0 0,0 0,324 Z" />
            </clipPath>
          </defs>
      ...
      <v-card-text class="text-subtitle-1 font-weight-black fade-in php-gradient-text gradient-text">
