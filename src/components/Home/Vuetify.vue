<template>
  <div class="fade-in mb-14">
    <v-card hover href="https://vuetifyjs.com/" rounded="xl" target="_blank">
      <div class="pt-4 fade-in d-flex justify-center">
        <svg fill="none" viewBox="0 0 512 512" width="120px" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <v-card-text class="text-subtitle-1 font-weight-black fade-in vuetify-gradient-text gradient-text">
