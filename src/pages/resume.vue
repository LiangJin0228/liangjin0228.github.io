<template>
    ...
    <v-main ref="scrollContainer">
        <!-- <v-navigation-drawer order=1 :permanent="!smAndDown" elevation="5" style="position: fixed; margin-top: 64px;">
        ...
        <v-sheet>
            ...
            <v-fab @click="scrollToTop()" class="me-4" icon="mdi-arrow-up" location="top end" absolute offset></v-fab>
        </v-sheet>
    </v-main>
</template>
    ...
    data() {
        return {
            ...
            items: [
                {
                    type: "header",
                    "prepend-avatar": '/liangjin-removebg.png',
                    title: "Tan Liang Jin",
