        ...
        <v-card-text>
            ...
            <v-form ref="form" v-model="valid">
                ...
                <v-container v-else fluid class="border bg-green-lighten-5" style="width: inherit; overflow-x: auto;">
                    <v-row v-for="(option, index) in node.options" style="width: inherit; overflow-x: auto;">
                        ...
                        <v-col cols="12">
                            <v-row class="py-1">
                                <v-col cols="12">
                                    <v-radio-group inline hide-details="auto">
                                        <v-row class="flex-nowrap">
                                            <v-col v-for="scale in node.configs.scales"
                                ...
                                <v-col cols="12">
                                    <v-radio-group inline v-model="radios[index]" :rules="rules" hide-details="auto">
                                        <v-row class="flex-nowrap">
                                            <v-col v-for="scale in node.configs.scales" class="text-center border pa-0">
                                                <v-radio :value="scale.value"></v-radio>
                                            </v-col>
                                        </v-row>
                                    </v-radio-group>
